...
CREATE TABLE `fangjianxinxi` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1619691044174 DEFAULT CHARSET=utf8 COMMENT='房间信息';
...
INSERT INTO `fangjianxinxi` VALUES ('1619691044173', '2021-04-29 18:10:43', '商家2', '温馨的家', '房间类型1', 'http://localhost:8080/homestay/upload/1619691026512.jpg', 'wifi', '200', 'nice', '188', '0', '0', '2021-04-29 10:11:19', '1', '1');
...
INSERT INTO `token` VALUES ('2', '1', 'abo', 'users', '管理员', 'epdaljebsjlcomjwj6kuflp1n9g9qe6d', '2021-03-06 00:02:04', '2021-04-29 11:10:57');
...
INSERT INTO `token` VALUES ('5', '22', '商家2', 'shangjia', '商家', 't07lf7o8er5ze59dzp0rwg1aop5wb1f8', '2021-04-29 15:11:57', '2021-04-29 11:11:28');
