    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.shangjiabianhao"
              placeholder="商家编号"
              clearable
              :readonly="ro.shangjiabianhao"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.minsumingcheng"
              placeholder="民宿名称"
              clearable
              :readonly="ro.minsumingcheng"
            ></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item class="input" label="房间设施" prop="fangjiansheshi">
              <el-input
                v-model="ruleForm.fangjiansheshi"
                placeholder="房间设施"
                readonly
        ...
        <el-col :span="12">
          ...
          >
            <el-input
              v-model="ruleForm.shouqujine"
              placeholder="收取金额"
              clearable
              :readonly="ro.shouqujine"
            ></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="收取金额" prop="shouqujine">
              <el-input
                v-model="ruleForm.shouqujine"
                placeholder="收取金额"
                readonly
      ...
      <el-row>
        <el-col :span="24">
          ...
          <div v-else>
            <el-form-item
              v-if="ruleForm.fangjianjieshao"
              label="房间介绍"
              prop="fangjianjieshao"
            >
              <span>{{ ruleForm.fangjianjieshao }}</span>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        tupian: [],
        fangjiansheshi: [],
        fangjianjiage: [{ validator: validateIntNumber, trigger: 'blur' }],
        fangjianjieshao: [],
        shouqujine: [],
    ...
    init(id, type) {
      ...
      if (this.type == 'info' || this.type == 'else') {
        ...
        for (var o in obj) {
          ...
          if (o == 'shouqujine') {
            this.ruleForm.shouqujine = obj[o]
            this.ro.shouqujine = true
            continue
          }
          if (o == 'thumbsupnum') {
